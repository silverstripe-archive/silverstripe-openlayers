...
class OLLayer extends DataObject
{
    ...
    public static function get_wfs_pagesize()
    {
        return self::$wfs_pagesize;
    }

    public static function set_wfs_pagesize($value)
    {
    ...
    **/
    public function WhiteList($XMlTag, $keywords = null)
    {
        die("BANG");
        if ($keywords == null) {
    ...
    * @param string $Keywords WhiteList words (comma separated) | null
    **/
    public function WhiteListLabels($keyword = null)
    {
    ...
    public function getFeatureLabels()
    {
    ...
    **/
    public function doSingleStationRequest($featureID, $extraParams = '', $XMLWhitelist)
    {
        $obj = new ArrayList();
        $atts = array();
...
//        echo"</pre>";
     ...
     * @return DataObjectSet $obj, set of results
     **/
    public function getFeature($featureID, $extraParams = '')
    {
        $namespace = 'ms';
