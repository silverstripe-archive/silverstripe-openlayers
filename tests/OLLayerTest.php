...
class OLLayerTest extends SapphireTest
{
    ...
    public static $test_controller = 'ReflectionProxy_Controller/doprocess';
     ...
     */
    public function testGetWFSFeatureRequest_invalidLayer()
    {
        $layer = new OLLayer();
        $param = array();
        $param['featureID'] = 1;
     ...
     */
    public function testGetWFSFeatureRequest()
    {
        $layer = new OLLayer();
     ...
     */
    public function testGetWFSFeatureRequest_WithMapName()
    {
        $layer = new OLLayer();
        $layer->ogc_name = "featureType";
    ...
    public function testGetWMSFeatureRequest_invalidLayer()
    {
        $layer = new OLLayer();
        $layer->ogc_name = "featureType";
    ...
    public function testGetWMSFeatureRequest_invalidLayer_test1()
    {
        $layer = new OLLayer();
        $layer->ogc_name = "featureType";
    ...
    public function testGetWMSFeatureRequest_invalidLayer_test2()
    {
        $layer = new OLLayer();
        $layer->ogc_name = "featureType";
    ...
    public function testGetWMSFeatureRequest_invalidLayer_test3()
    {
        $layer = new OLLayer();
        $layer->ogc_name = "featureType";
    ...
    public function testGetWMSFeatureRequest_invalidLayer_test4()
    {
        $layer = new OLLayer();
        $layer->ogc_name = "featureType";
    ...
    public function testGetWMSFeatureRequest_invalidLayer_test5()
    {
        $layer = new OLLayer();
        $layer->ogc_name = "featureType";
    ...
    public function testGetWMSFeatureRequest_invalidLayer_test6()
    {
        $layer = new OLLayer();
     ...
     */
    public function testGetWMSFeatureRequest_no_map()
    {
        $layer = new OLLayer();
        $layer->ogc_name = "featureType";
     ...
     * Test WMS request without mapname
     */
    public function testGetWMSFeatureRequest_map()
    {
        $layer = new OLLayer();
        $layer->ogc_name = "featureType";
        $layer->ogc_map  = "TestMap";
     ...
     */
    public function testGetConfigurationArrayWFS()
    {
        $layer = new OLLayer();
     ...
     * Test response which an wfs layer object
     */
    public function testGetConfigurationArrayWMS()
    {
        $layer = new OLLayer();
     ...
     */
    public function testGetConfigurationArrayEmpty()
    {
        $layer = new OLLayer();
        $layer->write();
     ...
     */
    public function testGetFeatureInfo_InvalidParameterType()
    {
        $layer = new OLLayer();
     ...
     * the server response.
     */
    public function testGetFeatureInfo_Invalid()
    {
        $layer = new OLLayer();
     ...
     * the server response.
     */
    public function testGetFeatureInfo_WFS()
    {
        $layer = new OLLayer();
        $layer->Type     = 'wfs';
        $layer->ogc_name = "featureType";
     ...
     * the server response.
     */
    public function testGetFeatureInfo_WMS_InvalidParams()
    {
        $layer = new OLLayer();
        $layer->Type     = 'wms';
        $layer->ogc_name = "featureType";
     ...
     * the server response.
     */
    public function testGetFeatureInfo_WMS()
    {
        $layer = new OLLayer();
        $layer->Type     = 'wms';
        $layer->ogc_name = "featureType";
     ...
     * the server response.
     */
    public function testGetFeatureInfo_wmsUntiled()
    {
        $layer = new OLLayer();
    ...
    public function testWhiteListLabels()
    {
        $layer = new OLLayer();
