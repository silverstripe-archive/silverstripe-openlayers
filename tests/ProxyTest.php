...
class ProxyTest extends FunctionalTest
{
     ...
     */
    public function testDoRequestNullValues()
    {
     ...
     */
    public function testDoRequest_AccessDeny()
    {
     ...
     * Test a proxy request to a server. We want to test the permission deny case.
     */
    public function testDoRequest_AccessDeny_MultipleDomains()
    {
        // set proxy configuration
     ...
     */
    public function testDoRequest_ValidRequest()
    {
        // set proxy configuration
     ...
     */
    public function testDoRequest_ValidRequest_MultipleDomain()
    {
        // set proxy configuration
     ...
     */
    public function testDoRequest_PostRequest()
    {
